  ...
  16                     	scross	off
  17  0000               _main:
  19                     ; 20   DISABLE_INTERRUPTS();
  21  0000 9b            sim
  23                     ; 22   sfr_CLK.CKDIVR.byte = 0x00;
  24  0001 725f50c6      	clr	20678
  25                     ; 24 	EEPROM_dataInit();
  ...
  40                     ; 29 	service_timing_init();
  41  0014 cd0000        	call	_service_timing_init
  43                     ; 31   ENABLE_INTERRUPTS(); 
  45  0017 9a            rim
  47  0018               L3:
  48                     ; 35 		service_timing_10ms_proc();
