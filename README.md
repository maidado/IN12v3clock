...
4. **Menu items:**  
   0. **Leading zero display:** 0 — Disabled, 1 — Enabled.  
   1. **Time format:** 0 — 24-hour, 1 — 12-hour.  
   2. **Normal mode indicator brightness:**  5%–100%.
   3. **Night mode indicator brightness:**   5%–100%.
   4. **Night brightness enable:** 0 — Disabled, 1 — Enabled.
   5. **Night interval start hour.**
   6. **Night interval start minute.**
   7. **Night interval end hour.**
   8. **Night interval end minute.**
   9. **RGB backlight in night mode:** 0 — Disabled, 1 — Enabled.
